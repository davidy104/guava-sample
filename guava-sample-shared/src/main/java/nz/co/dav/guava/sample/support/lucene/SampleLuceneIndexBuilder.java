package nz.co.dav.guava.sample.support.lucene;
...
public class SampleLuceneIndexBuilder {
	...
	public RAMDirectory buildIndex() throws IOException {
		...
		IndexWriter indexWriter = new IndexWriter(ramDirectory, new IndexWriterConfig(Version.LUCENE_40, new StandardAnalyzer(Version.LUCENE_40)));
