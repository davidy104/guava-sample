package nz.co.dav.guava.sample.model;
...
public class City {
	...
	public boolean equals(Object o) {
		...
		if (Doubles.compare(city.averageRainfall, averageRainfall) != 0)
			return false;
		if (population != city.population)
			return false;
		if (climate != city.climate)
			return false;
		if (name != null ? !name.equals(city.name) : city.name != null)
			return false;
		if (zipCode != null ? !zipCode.equals(city.zipCode) : city.zipCode != null)
			return false;
